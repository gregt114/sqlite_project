...
// Fuzzing compilation:
// afl-gcc-fast sqlsmith_harness.c -g -fsanitize=address -o sqlsmith_harness

// Fast compilation (debugging purposes, no AFL instrumentation or address sanitizer):
// gcc sqlsmith_harness.c -g -o sqlsmith_harness
...
int main(int argc, char **argv)
{
    ...
    sqlite3_exec(db, "CREATE TABLE test (INTEGER x, TEXT t, BLOB b);", NULL, NULL, NULL);
